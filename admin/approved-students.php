    ...
    <body class="top-navbar-fixed" id="showBody" onclick="showBody()">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage approved Applicants</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">manage approved students</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Manage Approved Students</h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div class=" col-md-12 col-md-12 col-sm-12" style="overflow:scroll; ">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                try {
                                                                    ...
                                                                    $results = $auth->displayAllSpecific('applicants', 'status', 1);
                                                                ...
                                                                ?>
                                                                            ...
                                                                            <td> <?php $status = $result['status'];
                                                                                    ...
                                                                                    if ($status == '1') { ?>
                                                                                    <strong>
                                                                                        <i class="fa fa-check btn btn-success " title="Approve Student">Approved</i> </strong><?php } ?>
                                                                            </td>
                                                                            <td>
                                                                                <a href="approved-students.php" onclick="deactivate('0','<?php echo $result['matno']; ?>')">
                                                                                    <i class="fa fa-ban btn btn-warning " title="Approve Applicant">Disapprove </i> </a>

                                                                                <a href="approved-students.php" onclick="deleteData('<?Php echo htmlentities($result['matno']) ?>')">
        ...
        <script>
            ...
            function deleteData(id) {
                ...
                if (result == true) {
                    $.post("request_pages/delete-request.php", {
                        id: id,
                        tableName: "applicants",
                        column_id: 'matno'
                    }, function(data, status) {
