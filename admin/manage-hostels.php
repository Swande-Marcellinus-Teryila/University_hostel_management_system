...
<html lang="en">
    <head>
        ...
        <title>Manage hostels| hostel management Jostum</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title"> <i class="fa fa-tasks"></i> manage Hostels</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active"><i class="fa fa-tasks"></i> manage hostels</li>
                                    </ul>
                                </div>
...
try {
    ...
    $results=$auth->displayAll('hostel_blocks');
 ...
 <td><?Php echo $i?></td> 
                                    ...
                                    <td><?php echo $result['hostel_name'];?> </td>
                                    <td><?php echo htmlentities($result['no_of_rooms']);?></td>
                                    <td><img src="../hostel_img/<?php echo htmlspecialchars($result['photo']);?>" class="img-responsive "  hieght="70px" width="135px" alt="Profile Pic."></td>

                                    <td><?php echo htmlspecialchars($result['gender']);?></td>
                                    <td><?php echo htmlspecialchars($result['location']);?></td>
                                    <td>  <a href="Manage-hostels.php"onclick="deleteData('<?Php echo htmlentities($result['id'])?>')"><i class="fa fa-trash btn btn-danger " title="Delete Record"></i> </a>

                                         <a href="edit-hostels.php?id=<?=$result['id']?>"><i class="fa fa-edit btn btn-primary " title="Edit Record"></i> </a>
                                    </td>
...
function deleteData(id){
    let result=confirm("Are you sure you want to delete this hostel block?");
    if(result==true){

             $.post("request_pages/delete-request.php",{id:id,tableName:"hostel_blocks", column_id:'id'},function(data,status){
           //$("#showMessage").html(data);
